...
version = str(uvplot.__version__)
# The full version, including alpha/beta/rc tags.
release = str(uvplot.__version__)
...
# documentation.
html_theme_options = {
    'githuburl': 'https://github.com/mtazzari/uvplot/',
...
man_pages = [
    (master_doc, 'uvplot', u'uvplot Documentation',
     [authors], 1)
]
...
texinfo_documents = [
    (master_doc, 'uvplot', u'uvplot Documentation',
     authors, 'uvplot', 'One line description of project.',
     'Miscellaneous'),
]
